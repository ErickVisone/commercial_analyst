...
-- decision to join more than one table was to create a star_schema model.
-- as the queries were lightweitgh, this join would not affect the production database at all
